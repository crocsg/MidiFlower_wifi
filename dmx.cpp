 ...
 * Modified by S Godin (Climate Change Lab) in 2024
 * 
...
#define DMX_SERIAL_INPUT_PIN    DMX_RX // pin for dmx rx
#define DMX_SERIAL_OUTPUT_PIN   DMX_TX // pin for dmx tx
#define DMX_SERIAL_IO_PIN       DMX_SELECT_REDE  // pin for dmx rx/tx change

#define DMX_UART_NUM            DMX_UART  // dmx uart
